...
const NavLg=()=>{
    return(
        ...
        <div className="flex gap-3 justify-center">
            ...
            <div className="w-36">
            <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="logo" className="py-6 w-32" />
            </div>

            <div className="py-3 flex gap-10 justify-between">
            <div className="w-full h-12 flex items-center bg-white gap-4 px-2 mx-2 py-2 rounded-md shadow-md">
            <div className="flex items-center gap-3">
